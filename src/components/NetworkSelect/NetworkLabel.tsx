...
const NETWORK_ID_TO_LABEL = {
  ...
  [CHAIN_IDS[NETWORK_NAMES.GNOSIS]]: "Gnosis",
  [CHAIN_IDS[NETWORK_NAMES.ARBITRUM]]: "Arbitrum",
  [CHAIN_IDS[NETWORK_NAMES.OPTIMISM]]: "Optimism",
};
...
const NETWORK_ID_TO_COLOR = {
  ...
  [CHAIN_IDS[NETWORK_NAMES.AVALANCHE]]: "rgb(0, 0, 0)",
  [CHAIN_IDS[NETWORK_NAMES.GNOSIS]]: "#48A9A6",
  [CHAIN_IDS[NETWORK_NAMES.ARBITRUM]]: "rgb(40, 160, 240)",
  [CHAIN_IDS[NETWORK_NAMES.OPTIMISM]]: "rgb(240, 26, 55)",
};
